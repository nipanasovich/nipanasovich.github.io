        ...
        <div className='about-me' id="about-me-link">
            ...
            <div className="info__briefly ">
                ...
                <p className='info__briefly--text'>
                    Увлеченный и целеустремленный разработчик без опыта.
                    В свободное время читаю и перевожу статьи посвященные веб-разработке, некоторые из них публикую на habr'е. 
                    Постоянно улучшаю свои навыки во всех областях, начиная разработкой и заканчивая повседневнными вещами.
